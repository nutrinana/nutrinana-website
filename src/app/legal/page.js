    ...
    return (
        <>
            <section className="mb-8">
                ...
                <p className="mb-4">Nutrinana is based in Kent, United Kingdom.</p>
                ...
                <p className="mb-4">
                    Nutrinana provides this website, including all information, tools, and services
                    available from this site (the &ldquo;Service&rdquo; or &ldquo;Services&rdquo;),
                    to you, the user, conditioned upon your acceptance of these Terms of Use
                    (&ldquo;Terms&rdquo;).
                </p>

                <p className="mb-4">
                    By visiting our site, engaging with our content, or purchasing Nutrinana
                    products through linked third-party platforms, you agree to be bound by these
                    Terms. These Terms apply to all users of the site, including without limitation
                    visitors, customers, vendors, and contributors of content.
                </p>

                <p className="mb-4">
                    Please read these Terms carefully before using our website. If you do not agree
                    with all of the Terms, you may not access the website or use our Services.
                </p>

                <p className="mb-4">
                    Any new features or tools added to the website in the future will also be
                    subject to these Terms. We reserve the right to update or change these Terms by
                    posting updates on this page. It is your responsibility to check this page
                    periodically for changes. Your continued use of or access to the website after
                    such changes constitutes acceptance of those changes.
                </p>
            ...
            <section className="mb-8">
                <h2 className="mb-2 text-2xl font-semibold">Section 1 - Website Use Terms</h2>

                <p className="mb-4">
                    By using this site, you represent that you are at least the age of majority in
                    your country of residence, or that you are the age of majority and have given
                    your consent for any minor dependents to use this site.
                </p>
            ...
            <section className="mb-8">
                <h2 className="mb-2 text-2xl font-semibold">Section 2 - General Conditions</h2>

                <p className="mb-4">
                    We reserve the right to refuse access to the website or Services to anyone for
                    any reason at any time.
                </p>

                <p className="mb-4">
                    You understand that your interactions with this website (not including payment
                    information handled by third-party processors) may involve transmissions over
                    various networks and changes to conform to the technical requirements of
                ...
                <p className="mb-4">
                    The headings used in this agreement are for convenience only and do not limit or
                    affect these Terms.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    ...
                    only. While we make every effort to ensure the accuracy of the content, we do
                    not guarantee that information on this site will always be accurate, complete,
                    or up to date.
                </p>

                <p className="mb-4">
                    Any reliance on the material on this site is at your own risk. Historical
                    information may be provided for reference but should not be considered current.
                    We reserve the right to update or modify content on this site at any time, but
                    we are under no obligation to do so. You agree that it is your responsibility to
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    ...
                    accurately on this website. However, we cannot guarantee that your
                    device&rsquo;s display will reflect colours or images exactly.
                </p>

                <p className="mb-4">
                    We reserve the right to discontinue or change products, packaging, or content at
                    any time without prior notice. Any product or service offered on this website is
                    void where prohibited by law.
                </p>

                <p className="mb-4">
                    We do not warrant that any products, services, or information obtained through
                    this website will meet your expectations, or that any errors on the site will be
                    corrected.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    Our website may provide access to or embed third-party tools, features, or
                    services (such as Instagram content, review widgets, or consent management
                    banners) over which we have no control or responsibility.
                </p>

                <p className="mb-4">
                    You acknowledge and agree that any use of such third-party tools or integrations
                    is provided on an &ldquo;as is&rdquo; and &ldquo;as available&rdquo; basis,
                    without warranties, representations, or conditions of any kind. We do not
                    endorse or assume liability for your use of these tools.
                </p>

                <p className="mb-4">
                    Your use of third-party tools is entirely at your own risk, and it is your
                    responsibility to ensure that you are familiar with and agree to the terms
                    provided by the relevant third-party provider(s).
                </p>

                <p className="mb-4">
                    We may also introduce new features or integrations in the future. Any such
                    additions will also be subject to these Terms of Service.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    ...
                    before you engage in any transaction. Complaints, claims, concerns, or questions
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    If you submit reviews, feedback, suggestions, ideas, proposals, or other
                    materials to us (whether through our website, email, or other channels)
                    (collectively, &ldquo;Submissions&rdquo;), you agree that we may use, edit,
                    publish, and distribute such Submissions in any medium without restriction.
                </p>

                <p className="mb-4">You acknowledge that:</p>
                <ol className="mb-4 list-decimal pl-6">
                    <li>We are under no obligation to maintain Submissions in confidence.</li>
                    <li>We are not required to provide compensation for Submissions.</li>
                    <li>We may choose, but are not obligated, to respond to Submissions.</li>
                </ol>
                ...
                <p className="mb-4">
                    ...
                    violates any party&rsquo;s intellectual property or these Terms of Service.
                </p>

                <p className="mb-4">
                    You agree that your Submissions will not violate any right of any third-party,
                    including copyright, trademark, privacy, personality or other personal or
                    proprietary right. You further agree that your Submissions will not contain
                    libellous or otherwise unlawful, abusive or obscene material, or contain any
                    ...
                    third-parties as to the origin of any Submissions. You are solely responsible
                    for any Submissions you make and their accuracy. We take no responsibility and
                    assume no liability for any Submissions posted by you or any third-party.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    ...
                    placing an order, submitting a review, or contacting us) is governed by our
                    Privacy Policy. To view our Privacy Policy, please see{" "}
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    Occasionally, there may be information on our website or in the Service that
                    contains typographical errors, inaccuracies, or omissions relating to product
                    descriptions, pricing, promotions, offers, shipping charges, transit times, or
                    availability.
                </p>
                ...
                <p className="mb-4">
                    ...
                    (including after you have placed an order).
                </p>
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    ...
                    prohibited from using our website or its content:
                </p>

                <ol className="mb-4 list-[lower-alpha] pl-6">
                    ...
                    <li>
                        to interfere with or circumvent the security features of the Service or any
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    We do not guarantee, represent, or warrant that your use of our website or
                    Services will be uninterrupted, timely, secure, or error-free.
                </p>

                <p className="mb-4">
                    We do not warrant that any results obtained from the use of the website or our
                    products will be accurate or reliable. From time to time, we may remove or
                    suspend access to the website, or discontinue Services or products, without
                    prior notice.
                </p>

                <p className="mb-4">
                    You expressly agree that your use of, or inability to use, the website and
                    Services is at your sole risk. Except as expressly stated by us in writing, the
                    website, its content, and all products and Services provided are made available
                    to you &ldquo;as is&rdquo; and &ldquo;as available,&rdquo; without any
                    representations, warranties, or conditions of any kind, whether express or
                    implied. This includes, without limitation, implied warranties or conditions of
                    merchantability, fitness for a particular purpose, durability, title, and
                    non-infringement.
                </p>

                <p className="mb-4">
                    In no case shall Nutrinana, our directors, officers, employees, affiliates,
            ...
            <section>
                ...
                <p className="mb-4">
                    ...
                    you no longer wish to use our Services, or when you stop using our website.
                </p>

                <p>
                    We may also terminate this agreement at any time without notice if, in our sole
